...
@implementation ZZNewsSheetItem1
...
- (void)setFlagType:(ZZCornerFlagType)flagType{
    ...
    if (flagType == ZZCornerFlagTypeNone) {
     ...
     BOOL isShakeAnimation = [ZZNewsSheetConfig1 defaultCofing].isShakeAnimation;
...
#pragma mark - SetUp
- (void)defaultConfig{
    self.backgroundColor = [ZZNewsSheetConfig1 defaultCofing].sheetBackgroundColor;
...
- (void)addTipsLab{
    ...
    tLab.textColor = [ZZNewsSheetConfig1 defaultCofing].sheetItemTitleColor;
    tLab.font = [ZZNewsSheetConfig1 defaultCofing].sheetItemFont;
...
//    [closeButton setBackgroundImage:GetImage(@"cha-1") forState:UIControlStateNormal];
    ...
    closeButton.backgroundColor = [ZZNewsSheetConfig1 defaultCofing].closeBackgroundColor;
}
