...
//        [emptyButton setImage:GetImage(@"duihao") forState:UIControlStateNormal];
...
- (void)setup
{
    self.view.backgroundColor = RGB(243, 244, 248);
    ...
    searchBar.placeholder = @"输入想要搜索的关键词";
...
{
    return self.showSearchHistory && self.searchHistories.count && PYSearchHistoryStyleCell == self.searchHistoryStyle ? (self.searchHistoryTitle.length ? self.searchHistoryTitle : @"历史搜索") : nil;
}
